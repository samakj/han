...
@DEVICE_LOCATION_TAGS_V0_BLUEPRINT.route("/device_location_tags/", methods=["POST"])
...
@DEVICE_LOCATION_TAGS_V0_BLUEPRINT.route("/device_location_tags/<int:device_location_tag_id>/", methods=["GET"])
...
@DEVICE_LOCATION_TAGS_V0_BLUEPRINT.route("/device_location_tags/", methods=["GET"])
...
@DEVICE_LOCATION_TAGS_V0_BLUEPRINT.route("/device_location_tags/<int:device_location_tag_id>/", methods=["PATCH"])
...
@DEVICE_LOCATION_TAGS_V0_BLUEPRINT.route("/device_location_tags/<int:device_location_tag_id>/", methods=["DELETE"])
...
@DEVICE_LOCATION_TAGS_V0_BLUEPRINT.route("/device_location_tags/backup/", methods=["POST"])
...
@DEVICE_LOCATION_TAGS_V0_BLUEPRINT.route("/device_location_tags/load/", methods=["POST"])
